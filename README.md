...
2. Unlike most other persistent identfiers, the DOI of a digital specimen contains additional metadata (e.g., name, catalogue number) beyond the URL to which it resolves. This allows access to some basic information about the specimen without the need to retrieve the full data object.
